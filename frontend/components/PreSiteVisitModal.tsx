...
const PROJECT_PRESENTATION_ID_MAP: Record<string, string> = {
  ...
  "balmora hillside wrong": "PRS-2F39B888",
  "1 presidential by sereno": "PRS-C84C75BF",
  "24k altura-wrong": "PRS-DB148E97",
  "spring shire - wrong": "PRS-2F1B5847",
...
function getPresentationId(projectName: string): string {
  const n = normalizeName(projectName);
  if (PROJECT_PRESENTATION_ID_MAP[n]) return PROJECT_PRESENTATION_ID_MAP[n];
